...
# CREATE SURFACES
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------
impactor_surface = model.parts['Impactor'].faces.findAt(((IMPACTOR_AND_SUPPORT_RADIUS, 0, 0),),)
model.parts['Impactor'].Surface(name='Impactor', side2Faces=impactor_surface)
support_surface = model.parts['Support'].faces.findAt(((IMPACTOR_AND_SUPPORT_RADIUS, 0, 0),),)
model.parts['Support' ].Surface(name='Support' , side2Faces=support_surface)
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------
# CREATE ASSEMBLY
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
OUTER_WALL_mean = 2.7
OUTER_WALL_std_dev = 0.4/6

INSIDE_WALL_SIDE_mean = 2
INSIDE_WALL_SIDE_std_dev = 0.6/6

INSIDE_WALL_MIDDLE_mean = 1.5
INSIDE_WALL_MIDDLE_std_dev = 0.6/6
